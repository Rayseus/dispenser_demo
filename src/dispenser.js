...
class Dispenser extends Component {
  ...
  getLowStock() {
    let stock_low = this.state.stocks.filter((e) => e.stock <= 5)
    this.setState({
      isLoaded: true,
      lowstocks: stock_low
    })
  ...
  handleDespensing(e) {
    ...
    // let item = this.findItem(e.target.value)
              ...
              <Form onSubmit={this.SubmitHandler}>
                {this.state.Screen2disability && (
                  <div>
                    ...
                    <Button variant="secondary" value=" " onClick={this.handleMaintainanceToggle} size="lg" block>Maintainance</Button>
